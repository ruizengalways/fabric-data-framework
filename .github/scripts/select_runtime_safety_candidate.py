...
state_path = "docs/internal/STATE.md"
replace_once(state_path, "  exact_candidate_source_selected: false\n", "  exact_candidate_source_selected: true\n")
replace_once(
    state_path,
...
replace_once(state_path, "  candidate_bytes_must_not_change: false\n", "  candidate_bytes_must_not_change: true\n")
replace_once(
    state_path,
...
replace_once(state_path, "  exact_current_candidate_selected: false\n", "  exact_current_candidate_selected: true\n")
replace_once(
    state_path,
...
consistency_path = "tests/test_current_docs_consistency.py"
replace_once(consistency_path, '        "exact_candidate_source_selected: false",\n', '        "exact_candidate_source_selected: true",\n')
replace_once(
    consistency_path,
    '        "current_source_candidate_git_sha: not_selected_after_runtime_safety_hardening",\n',
    '        "current_source_candidate_git_sha: b1b69c6ecd465b63c7e83d8405733a0c34962c8c",\n',
