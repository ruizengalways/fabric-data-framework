...
candidate_identity:
  ...
  selected_candidate:
    ...
    candidate_wheel_artifact_id: 10297211433
    candidate_wheel_artifact_name: framework-wheel-5d4b69702acc3e362a52a3b890cc7096f2acc02a
    candidate_wheel_filename: fabric_data_framework-0.4.0-py3-none-any.whl
    framework_artifact_sha256: 5e19368c5c63e48e78abb47aa095638d4f0b39c831fc909c37df6817ed7e21a8
...
```text
5d4b69702acc3e362a52a3b890cc7096f2acc02a
```

The exact post-merge main gates are:

```text
framework-ci               34689765814  PASS
installed-wheel-acceptance 34689765815  PASS
```

The retained framework-ci artifact is:

```text
artifact id    10297211433
artifact name  framework-wheel-5d4b69702acc3e362a52a3b890cc7096f2acc02a
...
```text
framework_artifact_sha256
= 5e19368c5c63e48e78abb47aa095638d4f0b39c831fc909c37df6817ed7e21a8
```

The outer Actions artifact digest is `sha256:e3e4ef03e8cbb500c1f7eeb2bd8e5af2aae6bd3b3de91c4a7ac55ab8e901547e` and is retained only as provenance;
